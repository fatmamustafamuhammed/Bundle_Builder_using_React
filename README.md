...
- **Local JSON over a backend:** a static `bundleData.js` was used since a backend was called out as a bonus, not a requirement. This keeps the setup to a single `npm install` + `npm run dev`.
